...
urlpatterns = [
    ...
    path('<int:id>/editar/', views.ProfissionalUpdateView.as_view(), name='editar_profissional'),
    path('<int:id>/deletar/', views.deletar_profissional, name='deletar_profissional'),
    path('<int:id>/detalhes/', views.detalhes_profissional, name='detalhes_profissional'),
